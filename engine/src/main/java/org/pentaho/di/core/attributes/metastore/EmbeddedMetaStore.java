...
public class EmbeddedMetaStore extends BaseMetaStore implements ReadWriteLock {
    ...
    @Override
    public JsonElementType getElementType(final String namespace, final String elementTypeId)
    ...
    @Override
    public List<IMetaStoreElementType> getElementTypes(final String namespace)
            throws MetaStoreException {
    ...
    @Override
    public void updateElementType(String namespace, IMetaStoreElementType elementType)
            throws MetaStoreException {
        elementType.setNamespace(namespace);
    ...
    @Override
    public void deleteElementType(final String namespace,
    ...
    @Override
    public List<String> getElementIds(final String namespace,
                                      final IMetaStoreElementType elementType) throws MetaStoreException {
        return MetaStoreUtil.executeLockedOperation(readLock(), new Callable<List<String>>() {
                    @Override
                    public List<String> call() {
    ...
    @Override
    public JsonElement getElement(final String namespace, final IMetaStoreElementType elementType,
