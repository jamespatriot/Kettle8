...
public class FTPSConnection implements FTPListener {
     ...
     *
     * @param type true: proxy username
     */
     ...
     *
     * @param type true: proxy password
     */
     ...
     *
     * @param type true: connection type
     */
