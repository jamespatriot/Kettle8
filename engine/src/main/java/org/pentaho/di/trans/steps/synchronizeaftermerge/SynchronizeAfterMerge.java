...
public class SynchronizeAfterMerge extends BaseStep implements StepInterface {
    ...
    public String getLookupStatement(RowMetaInterface rowMeta) {
    ...
    // Lookup certain fields in a table
    public String getUpdateStatement(RowMetaInterface rowMeta) {
        DatabaseMeta databaseMeta = meta.getDatabaseMeta();
    ...
    public String getDeleteStatement(RowMetaInterface rowMeta) {
        DatabaseMeta databaseMeta = meta.getDatabaseMeta();
