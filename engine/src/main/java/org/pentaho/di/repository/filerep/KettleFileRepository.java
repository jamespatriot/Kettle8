...
public class KettleFileRepository extends AbstractRepository {
    ...
    private String[] getDatabaseNames(ObjectId[] databaseIds) {
    ...
    @Override
    public long getJobEntryAttributeInteger(ObjectId id_jobentry, int nr, String code) {
        return 0;
    }

    @Override
    public String getJobEntryAttributeString(ObjectId id_jobentry, int nr, String code) {
        return null;
    }
    ...
    public void insertJobNote(ObjectId id_job, ObjectId id_note) {
    }
    ...
    public void insertTransNote(ObjectId id_transformation, ObjectId id_note) {
    ...
    @Override
    public Condition loadConditionFromStepAttribute(ObjectId id_step, String code) {
    ...
    public ObjectId saveCondition(Condition condition, ObjectId id_condition_parent) {
        return null;
    }
    ...
    public UserInfo loadUserInfo(String login, String password) {
        return null;
    }

    public void renameUser(ObjectId id_user, String newname) {
    }
