...
public interface RepositoryExtended extends Repository {
     ...
     *
     * @param dirId                 The ObjectId of the repository directory to move
     * @param newParent             The RepositoryDirectoryInterface that will be the new parent of the repository directory (May be null if a
     *                              move is not desired)
     * @param newName               The new name of the repository directory (May be null if a rename is not desired)
     * @param renameHomeDirectories true if this is an allowed action
     ...
     *
     * @param dir                   The ObjectId of the repository directory to move
     * @param deleteHomeDirectories true if this is an allowed action
     * @throws KettleException
     */
