...
public interface Repository {
     ...
     * @param overwrite         Overwrite any existing objects involved in saving {@code repositoryElement}, e.g. repositoryElement,
     ...
     * @param setInternalVariables set to true if you want to automatically set the internal variables of the loaded transformation. (true is
     ...
     * @param newDirectory      The RepositoryDirectoryInterface that will be the new parent of the transformation (May be null if a move
     *                          is not desired)
     ...
     *
     * @param id_transformation The ObjectId of the transformation to move
     * @param versionComment    Version comment for rename
     * @param newDirectory      The RepositoryDirectoryInterface that will be the new parent of the transformation (May be null if a move
     *                          is not desired)
     * @param newName           The new name of the transformation (May be null if a rename is not desired)
     * @return The ObjectId of the transformation that was moved
     ...
     * @param versionComment Version comment for rename
     * @param newDirectory   The RepositoryDirectoryInterface that will be the new parent of the job (May be null if a move is not
     *                       desired)
     ...
     * @param newParentDir The RepositoryDirectoryInterface that will be the new parent of the repository directory (May be null if a
     *                     move is not desired)
