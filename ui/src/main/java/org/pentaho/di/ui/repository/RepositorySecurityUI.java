...
public class RepositorySecurityUI {
     ...
     *
     * @param shell        The parent frame to display error dialog
     * @param repository   The repository meta object
     * @param displayError If true, then display an error dialog if there is a security error
