...
public class SharedObjectSyncUtil {
     ...
     *
     * @param slaveServer data to share
     */
     ...
     *
     * @param clusterSchema data to share
     */
     ...
     *
     * @param partitionSchema data to share
     */
