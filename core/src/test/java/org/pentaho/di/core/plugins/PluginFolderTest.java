...
public class PluginFolderTest {
    ...
    @Test
    public void testIsPluginXmlFolder_SetPluginXmlFolder() {
    ...
    @Test
    public void testIsPluginAnnotationsFolder_SetPluginAnnotationsFolder() {
        plFolder = new PluginFolder(PLUGINS_DIR_NAME, false, true);
        assertNotNull(plFolder);
    ...
    @Test
    public void testGetFolder_SetFolder() {
