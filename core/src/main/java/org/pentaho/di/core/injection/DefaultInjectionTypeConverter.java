...
public class DefaultInjectionTypeConverter extends InjectionTypeConverter {
    ...
    @Override
    public String boolean2string(Boolean v) {
        if (v == null) {
            return null;
        }
        return v ? "Y" : "N";
    ...
    @Override
    public int boolean2intPrimitive(Boolean v) {
        return v ? 1 : 0;
    }
    ...
    @Override
    public long boolean2longPrimitive(Boolean v) {
        return v ? 1 : 0;
    }
    ...
    @Override
    public boolean boolean2booleanPrimitive(Boolean v) {
        return v.booleanValue();
    }

    @Override
    public Boolean boolean2boolean(Boolean v) {
        if (v == null) {
            return null;
        }
        return v;
    ...
    @Override
    public String integer2string(Long v) {
        if (v == null) {
            return null;
        }
        return v.toString();
    ...
    @Override
    public long integer2longPrimitive(Long v) {
        return v.longValue();
    }
    ...
    @Override
    public boolean integer2booleanPrimitive(Long v) {
    ...
    @Override
    public String number2string(Double v) {
        if (v == null) {
            return null;
        }
        return v.toString();
    ...
    @Override
    public long number2longPrimitive(Double v) {
        return Math.round(v);
    }
